...
# Explorar todas las sub-topologías de una red (función pura, sin side effects)
...
function ejecutar(motor::MotorNube)
    ...
    # 5. Merge: encontrar la mejor red global
    mejor_red = nothing
    mejor_precision = 0.0
